function plotMeasureForNeuronMovieArrow(measureMatrix, thresholdValues, ...
        artifactIDsMatrix, clusterArtifactNo, caxisLim, markSelectedMovie, ...
        selectedThresholds, markSelectedThresholds, detectedSpikesNo, arrowIdx)
...
function plotArrow(arrowIdx)
    y = -1;
    text(arrowIdx, y,'\uparrow','fontsize',15, 'color' , 'r',...
